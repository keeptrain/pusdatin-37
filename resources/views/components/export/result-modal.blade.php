            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                    ...
                    <div
                        ...
                        <p class="text-sm text-gray-600 mb-4">Download as PDF</p>

                        <!-- Download Button -->
                        @hasanyrole('head_verifier')
                        <a
                            href="{{ route('head-filtered-pdf', [
                                'start_date' => $startDate,
                                'end_date' => $endDate,
                                'status' => $status,
                                'source' => $source,
                            ]) }}"
                            class="inline-flex items-center justify-center px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg group-hover:bg-red-700 transition-colors duration-200">
                            <svg
                                class="w-4 h-4 mr-2"
                                fill="currentColor"
                                viewBox="0 0 20 20">
                ...
                <div
                    ...
                    <div
                        ...
                        <p class="text-sm text-gray-600 mb-4">Download as Excel</p>

                        <!-- Download Button -->
                        @hasanyrole('head_verifier')
                        <a
                            href="{{ route('head_verifier-filter-excel', [
                            'start_date' => $startDate,
                            'end_date'   => $endDate,
                            'status'     => $status,
                            'source'     => $source,
                            ...
                            target="_blank"
                            class="inline-flex items-center justify-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg group-hover:bg-green-700 transition-colors duration-200">
                            <svg
                                class="w-4 h-4 mr-2"
                                fill="currentColor"
                                viewBox="0 0 20 20">
                        ...
                        @hasanyrole('si_verifier')
                        <a
                            href="{{ route('si_verifier-filter-excel', [
                            'start_date' => $startDate,
                            'end_date'   => $endDate,
                            'status'     => $status,
                            ]) }}"
                        ...
                        @hasanyrole('data_verifier')
                        <a
                            href="{{ route('data_verifier-filter-excel', [
                            'start_date' => $startDate,
                            'end_date'   => $endDate,
                            'status'     => $status,
                            ]) }}"
                        ...
                        @hasanyrole('pr_verifier|promkes_verifier')
                        <a
                            href="{{ route('pr_verifier-filter-excel', [
                            'start_date' => $startDate,
                            'end_date'   => $endDate,
                            'status'     => $status,
                            ]) }}"
