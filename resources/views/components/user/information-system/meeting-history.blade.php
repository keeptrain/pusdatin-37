    ...
    <div class="flex flex-col space-y-2">
        @if ($meeting->place['type'] === 'location')
            <div class="flex items-center">
                ...
                <div class="text-gray-900">
                    <p><span class="text-gray-500">Lokasi:</span> {{ $meeting->place['value'] }}</p>
                </div>
            </div>
        @elseif ($meeting->place['type'] === 'link')
            <div class="flex items-center">
                ...
                <div>
                    ...
                    @if (isset($meeting->place['password']))
                        <p class="text-gray-500">Password: {{ $meeting->place['password'] }}</p>
                    @endif
                </div>
            </div>
        @endif
        ...
        <div class="flex items-center">
            ...
            <div class="flex text-gray-900">
                <p>{{ $meeting->date }} • </p>
                <p class="ml-1">{{ $meeting->startAtTime }} - {{ $meeting->endAtTime }}</p>
            </div>
        </div>
    </div>
