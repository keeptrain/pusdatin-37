<section class="pt-32 pb-20 bg-gradient-to-b from-[#f2f6ff] to-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-center">
            <div class="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10">
                <h1 class="text-4xl sm:text-5xl font-bold mb-6 leading-tight">
                    Portal Layanan Digital
                    <span class="bg-clip-text text-transparent bg-gradient-to-r from-[#364872] to-[#697AA4]"> Pusdatin</span>
                </h1>
            ...
            <div class="lg:w-1/2 relative">
                <div class="relative z-10 bg-white rounded-2xl shadow-xl p-6 border border-purple-100 animate-[float_5s_ease-in-out_infinite]">
                    ...
                    <div class="mt-6 bg-gray-50 rounded-lg p-4 border border-gray-100">
                        ...
                        <div class="h-2 bg-indigo-200 rounded-full w-2/3"></div>
                    </div>
                </div>
                <div class="absolute -bottom-6 -right-6 w-64 h-64 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-full opacity-20 blur-3xl"></div>
                <div class="absolute -top-10 -left-10 w-40 h-40 bg-gradient-to-br from-teal-400 to-teal-600 rounded-full opacity-20 blur-3xl"></div>
            </div>
        </div>
    </div>
</section>