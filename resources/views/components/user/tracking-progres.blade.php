                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex items-start mb-8 relative">
                        <div class="flex flex-col items-center mr-4">
                            ...
                            <div class="absolute left-6 top-6">
                                <div class="w-3 h-3 rounded-full z-20 border-2 border-white bg-red-500 transform -translate-x-1/2"></div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-start mb-8 relative">
                        <div class="flex flex-col items-center mr-4">
                            ...
                            <!-- Step Indicator -->
                            <div class="absolute left-6 top-6">
                                <div class="w-3 h-3 rounded-full z-20 border-2 border-white bg-white transform -translate-x-1/2"></div>
                            </div>
                        </div>
