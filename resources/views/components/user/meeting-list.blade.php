<div class="space-y-4 p-2 mb-4 mt-3">
    ...
    <div class="mb-4 flex items-center space-x-4">
        ...
        <flux:heading size="xl" class="flex items-center text-accent dark:text-white text-center gap-2">
    ...
    @foreach ($meetingList as $dateGroup)
        ...
        <div class="flex items-center gap-4">
            ...
            <flux:heading size="xl"
                class="text-5xl {{ $dateGroup['has_meetings'] ? 'text-accent dark:text-white' : 'text-gray-300' }}">
