<div class="bg-white border-gray-200 px-4 py-6">
        ...
        <div class="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
            ...
            <div class="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
                ...
                {{-- <div class="relative w-full sm:w-64">
                    ...
                    <flux:input wire:model.live.debounce.500ms="searchQuery" placeholder="Search requests..."
                        class="w-full sm:w-64" />
                </div> --}}
            </div>
        </div>
    </div>
    <section class="flex flex-1 gap-6 mt-3 border-b cursor-pointer">
        <a x-on:click="activeTab = 'tab1'" class="py-3" :class="{
            ' border-b-2 border-zinc-800': activeTab === 'tab1',
            'text-gray-500 hover:text-gray-700': activeTab !== 'tab1'
        }"">Sistem informasi & data</a>
        <a x-on:click="activeTab = 'tab2'" class="py-3"  :class="{
            'border-b-2 border-zinc-800': activeTab === 'tab2',
