<x-mail.partials.base-pusdatin-layout title="Pemberitahuan membutuhkan dokumen NDA" :message="$message">
    ...
    <p style="font-size: 14px; color: #333;">
        Permohonan layanan yang anda ajukan dengan judul <span
            style="font-weight: bold;">{{ $data['title'] }}</span>, jenis layanan <span style="font-weight: bold;">Sistem
    ...
    <p style="font-size: 14px; color: #333;">
        Harap kesediaan Bapak/Ibu untuk segera mengirimkan dokumen Surat Perjanjian Kerahasiaan (NDA).
        Berikut tata cara mengirimkan dokumen Surat Perjanjian Kerahasiaan:
    </p>
    <p style="font-size: 14px; color: #333;">1. Klik tombol di bawah ini untuk diarahkan ke halaman terkait (memerlukan login)</p>
    <a href="{{ $data['url'] }}"
    ...
    <p style="font-size: 14px; color: #333;">2. Selanjutnya akan terdapat sebuah peringatan seperti gambar berikut, lalu klik tombol "Silahkan upload disini"
    </p>

    <img src="{{ $message->embed(storage_path('app/public/callout-additional-document.png')) }}" alt="NDA" style="width: 600px;">
