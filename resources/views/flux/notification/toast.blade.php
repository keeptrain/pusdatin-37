...
<div
    ...
    id="toast-container"
    class="flex flex-col fixed p-3 top-6 right-6 z-20 rounded-xl border-1 border-gray-300 shadow-md bg-white dark:bg-gray-800 text-black dark:text-white w-auto max-w-md"
>
