@php
    $statuses = ['Permohonan Masuk', 'Disposisi', 'Proses', 'Disetujui Kasatpel', 'Disetujui Kapusdatin'];
        ...
        <div class="relative flex items-center justify-between w-full">
            ...
            @foreach ($statuses as $index => $stepStatus)
                <div class="relative flex flex-col items-center">
                    ...
                    {{-- Label --}}
                    @if ($showLabels ?? true)
                        <span class="absolute mt-6 text-xs font-medium text-center whitespace-wrap
