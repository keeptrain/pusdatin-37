    ...
    <div class="lg:p-3">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-600 text-sm">Create and manage templates displayed on the whole page</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @foreach ($templates as $template)
                <div
                    class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200 hover:bg-zinc-50 cursor-pointer">
                    <div class="relative">
                        <img src="https://cdn.prod.website-files.com/5fda3048302e579473bfb454/604127094e44c9854095cad4_Project%20Documentation%20Template.webp"
                            alt="Invoice Template" class="w-full h-48 object-cover">
                        <div class="absolute top-3 right-3">
                            <span
                                class="bg-green-500 text-white text-xs px-2 py-1 rounded-full">{{ $template->is_active }}</span>
                        </div>
                    </div>
                    <div class="p-4">
                        ...
                        <div class="flex items-center text-sm text-gray-500 mb-4">
                            <span class="flex items-center mr-4">
                                <i class="fas fa-calendar-alt mr-1"></i> Updated: {{ $template->updated_at }}
                            </span>
            ...
            @if (count($templates) < 6)
                <!-- Add Template Card -->
                <div
                    class="bg-gray-50 rounded-lg border border-dashed border-gray-300 flex items-center justify-center h-96">
