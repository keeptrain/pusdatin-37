<div>
    <div class="lg:p-3">
        ...
        <div class="flex gap-2 mb-4">
            <button
                ...
                Hapus Terpilih (<span x-text="@js(count($selectedPrRequest))">{{ count($selectedPrRequest) }}</span>)
            </button>
    ...
    <style>
        ...
        #prRequestsTable tbody tr:hover {
        ...
        /* Don't apply cursor pointer to checkbox column and action column */
        #prRequestsTable tbody tr td:first-child,
        #prRequestsTable tbody tr td:last-child {
            cursor: default;
        }
    ...
    <script>
        ...
        function bindCheckboxEvents() {
            ...
            $('#prRequestsTable tbody tr').off('click').on('click', function(e) {
                ...
                if (clickedColumnIndex === 0 || clickedColumnIndex === 4 || clickedColumnIndex === 8) {
                    return;
                }
        ...
        function updateButtonStates() {
            ...
            $('button[wire\\:click="$set(\'selectedPrRequest\', [])"]').closest('div').hide();
        }
